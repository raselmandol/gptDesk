# GPT Deskt(aka GPT Teacher) (Under Development)
...
The application is the desktop version of original OpenAI product [ChatGPT](https://chat.openai.com/) . So the data and privacy policy is same as the original product. [Read Here](https://openai.com/policies/privacy-policy)
